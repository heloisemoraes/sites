...
function multipurpose_setup(){
 ...
 function multipurpose_enqueue_scripts(){
   ...
   /* wp_enqueue_style('multipurpose-less',get_template_directory_uri().'/css/style.less?v=1'); */
    ...
    wp_enqueue_script('multipurpose-pag',get_template_directory_uri().'/js/site.js',array('jquery'));
