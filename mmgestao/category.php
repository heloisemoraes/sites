    ...
    <div class="postagem">
    	<div class="post_header">
			...
			<div class="post_footer">	
					...
					<div class="assinatura col-xs-12 col-sm-4">	
						<div class="assi">
							<img src="<?php bloginfo('stylesheet_directory'); ?>/imagens/assi.png" class="img-responsive"/>
						</div>
					</div>	
						<div class="redes col-xs-12 col-sm-4">
