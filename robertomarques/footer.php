    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-xs-12  mt-3"> 
                <div class="col-sm-6 col-xs-12 tel mt-2"><?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('E-mail') ):  endif; ?></div>
                <div class="col-sm-6 col-xs-12 tel mt-2"><?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Telefone') ):  endif; ?></div>  
            </div>
        </div>
    </div>
</div>
